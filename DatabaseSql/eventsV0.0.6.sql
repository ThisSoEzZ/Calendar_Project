...
(116, 614259044, '1', 'นาย', 'ธนชาติ', 'ชาวนาฝ้าย', 'กลับบ้าน', '2021-12-28 16:30:00', '2021-12-28 16:30:00', '#8B008B', 1, '1', 'กลับบ้าน', 'การไฟฟ้าส่วนภูมิภาคอำเภอนครชัยศรี', 'Classroom', 10, ' กฟก3', ' กฟก3', '0985652625', 'เครื่องคอมพิวเตอร์,เครื่องฉายและจอโปรเจ็คเตอร์,เครื่องเสียงพร้อมอุปกรณ์', 0, 'เครื่องดื่ม,อาหารว่าง'),
...
(119, 614259055, '4', 'นาย', 'สรวิชญ์', 'เอกณรงค์พันธ์', 'กินข้าว', '2021-12-29 12:00:00', '2021-12-29 13:00:00', '#8B008B', 2, '3', 'กินข้าวร้านตู่ ส้มตำ', 'การไฟฟ้าส่วนภูมิภาคอำเภอนครชัยศรี', 'Webx', 10, ' กฟก3', ' กฟก3', '0863616258', 'เครื่องคอมพิวเตอร์,เครื่องฉายและจอโปรเจ็คเตอร์,เครื่องเสียงพร้อมอุปกรณ์', 0, 'เครื่องดื่ม');
...
--
ALTER TABLE `events`
  MODIFY `meeting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=120;

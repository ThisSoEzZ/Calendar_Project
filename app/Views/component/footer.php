<footer class="footer bg-purple">
    <div class="container ">
      ...
      <div class="row align-items-center justify-content-md-between">
        <div class="col-md-6">
          <div class="copyright">
            <a class="text-light">&copy; 2020</a> <a href="" class="text-light" target="_blank">Creative Tim</a>.
          </div>
        </div>
        <div class="col-md-6">
          <ul class="nav nav-footer justify-content-end">
            <li class="nav-item">
            <button type="button" class="btn btn-info">Creative Tim</button>&nbsp;
            </li>
            <li class="nav-item">
            <button type="button" class="btn btn-info">About Us</button>&nbsp;
            </li>
            <li class="nav-item">
            <button type="button" class="btn btn-info">Blog</button>&nbsp;
            </li>
            <li class="nav-item">
            <button type="button" class="btn btn-info">License</button>&nbsp;
              <!-- <a href="" class="text-right nav-link " target="_blank">License</a> -->
            </li>
          </ul>
        </div>
      </div>

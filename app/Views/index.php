          ...
          <div class="col px-0">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-6 text-center">
                <img src="<?php echo base_url(); ?>/assets/img/brand/Pealogo.png" style="width: 475px;" class="img-fluid">
                ...
                <div class="mt-5">
                  ...
                  <img src="<?php echo base_url(); ?>/assets/img/brand/creativetim-white-slim.png" style="height: 28px;">
                </div>
              </div>
            </div>
          </div>

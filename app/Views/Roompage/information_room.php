      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">ห้องประชุม</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">หน้าเเรก</a>
                  ...
                  <li class="breadcrumb-item active">ห้องประชุม
                  </li>
                </ol>
              </div>
            </div>
    ...
    <?php if ($room) : ?>
		...
		<div class="col-lg-4 col-md-12">
			...
			<div class="card">
                ...
                <hr>
				<div class="card-body">
					<p class="card-text">รายละเอียด : <?php echo $room['room_name']; ?></p>
                    <p class="card-text">จำนวนผู้เข้าใช้ : <?php echo $room['room_name']; ?></p>
					<p class="card-text">อุปกรณ์ : <?php echo $room['room_name']; ?></p>

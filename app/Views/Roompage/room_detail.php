      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">รายละเอียดห้องประชุม</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                ...
                <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">หน้าเเรก</a>
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>/index.php/room/information_room">ข้อมูลส่วนตัว</a>
                  </li>
                  <li class="breadcrumb-item active">รายละเอียดห้องประชุม
                  </li>
                </ol>
              </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">รายละเอียดห้องประชุม</h4>
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="post" action="<?= site_url('/index.php/submit-form') ?>">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    <h2 class="fs-title">ข้อมูลผู้จองห้องประชุม</h2> <input type="email" name="email" placeholder="Email Id" /> <input type="text" name="uname" placeholder="UserName" /> <input type="password" name="pwd" placeholder="Password" /> <input type="password" name="cpwd" placeholder="Confirm Password" />
                                </div> <input type="button" name="next" class="next action-button" value="ไปต่อ" />
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
                            ...
                            <fieldset>
                                ...
                                </div> <input type="button" name="previous" class="previous action-button-previous" value="ย้อนกลับ" /> <input type="submit" name="make_payment" class="next action-button" value="ตกลง" />
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
